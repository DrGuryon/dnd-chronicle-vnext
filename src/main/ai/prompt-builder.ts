...
export function buildChronicleInstructions(
  ...
  return [
    ...
    'Never invent an ID. If entity resolution is ambiguous, ask or use chronicle.resolve_entity.',
    ...
    'You may propose state changes only with chronicle.propose_turn_transaction.',
